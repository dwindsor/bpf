#!/bin/bash
# Boot the seal-v2 kernel with a 9p rootfs (host / passthrough),
# replicating the kernel-patches BPF CI vmtest environment.
# Usage: run-vm-seal-v2.sh <init-script> <console-log>
set -eu

KERNEL=/home/dave/seal-v2/arch/x86/boot/bzImage
INIT=$1
LOG=$2
